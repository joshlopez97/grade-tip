! function(t) {
    ...
    var e = t.HTMLCanvasElement && t.HTMLCanvasElement.prototype,
        ...
        i = (o || r) && t.atob && t.ArrayBuffer && t.Uint8Array && function(t) {
            ...
            if (!(e = t.match(a))) throw new Error("invalid data URI");
            for (i = e[2] ? e[1] : "text/plain" + (e[3] || ";charset=US-ASCII"), l = !!e[4], u = t.slice(e[0].length), c = l ? atob(u) : decodeURIComponent(u), f = new ArrayBuffer(c.length), b = new Uint8Array(f), d = 0; d < c.length; d += 1) b[d] = c.charCodeAt(d);
